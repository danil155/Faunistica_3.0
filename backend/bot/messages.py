class Messages:
    ...
    def registration_complete() -> str:
        return 'Спасибо за ответ, ваша регистрация закончена!\n' \
               'Для получения пароля и публикации используйте команду /auth\n\n' \
    ...
    def new_password(temp: str, username) -> str:
        return (
            'Ваш <b>новый пароль</b> для <a href="https://faunistica.ru/">сервиса</a> 🥳\n\n'
            f'P.S. ваш никнейм 🤫: {username}\n\n'
            'Пароль указан ниже и действует бессрочно (пока не забудете).\n\n'
            'Чтобы скопировать его — просто нажмите на него:\n'
            f'<code>{temp}</code>'
        )
