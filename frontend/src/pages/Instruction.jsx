                        ...
                        <>
                            <div>
                                <p>{t("sections.registration.step11")}
                                    <Link to={"https://t.me/FaunisticaV3Bot"}
                                          target={"_blank"}> https://t.me/FaunisticaV3Bot</Link><br/>
                            ...
                            <div>
                                <p>{t("sections.registration.step21")} <Link to={"https://faunistica.ru/"}
                                                                             target={"_blank"}>https://faunistica.ru/</Link> {t("sections.registration.step22")}<br/><br/>
                                </p>
                    ...
                    {collapsed.telegram_bot && (
                        <>
                            ...
                            <div className={"attention"}>
                                <p>{t("sections.telegram_bot.alert")} <Link to={"https://faunistica.ru/feedback"}
                                                                            target={"_blank"}>https://faunistica.ru/feedback</Link>
                                    <br/>
                                    <br/>
                                </p>
                            </div>
                ...
                <div className="section">
                    ...
                    {collapsed.beginning_work && (
                        <>
                            ...
                            <img className="full-width middle" src={work1}
                            ...
                            <img className={"full-width middle"} src={work2}
                        ...
                        <>
                            ...
                            <p>
                                <Trans i18nKey="sections.geo.example2_intro" t={t}>
                                    В публикации из <Link
                                    to={"https://sozontov.cc/arachnolibrary/files/p5099_2014_Esyunin_Ukhova.pdf"}
                                    target={"_blank"}>Примера 2</Link> в начале статьи, даны координаты каждой
                                    исследованной площадки. Две площадки выделены желтым для примера:
                                </Trans>
                            </p>
                            <div className={"horizontal"}>
